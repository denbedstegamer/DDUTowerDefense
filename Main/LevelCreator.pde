public class LevelCreator {
  ...
  public LevelCreator() {
    ...
    chooseBackground = new Button(squaresX, 0, width-squaresX, height/8, "Background","","") {
      @Override
        public void action() {
        if (!isSelectingFile) {
    ...
    createObstacle = new Button(squaresX, height/4, width-squaresX, height/8, "Create Obstacle","","") {
      @Override
        public void action() {
    ...
    createPath = new Button(squaresX, height/4+height/8, width-squaresX, height/8, "Create Path","","") {
      @Override
        public void action() {
        isSettingPath = true;
    ...
    removeObstacle = new Button(squaresX, height/2, width-squaresX, height/8, "Remove Obstacle","","") {
      @Override
        public void action() {
    ...
    clearPath = new Button(squaresX, height/2+height/8, width-squaresX, height/8, "Clear Path","","") {
      @Override
        public void action() {
        clearPath();
    ...
    chooseLevel = new Button(squaresX, height/2+height/4, width-squaresX, height/8, "Edit Level","","") {
      @Override
        public void action() {
        if (!isSelectingFile) {
