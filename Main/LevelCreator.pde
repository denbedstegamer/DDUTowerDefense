public class LevelCreator {
  ...
  public LevelCreator() {
    ...
    chooseBackground = new Button(width-(width-squaresX), height/9*0, width-squaresX, height/9, "Background", "", "") {
      @Override
        public void action() {
        if (!isSelectingFile) {
    ...
    saveLevel = new Button(width-(width-squaresX), height/9*1, width-squaresX, height/9, "Save Level", "", "") {
      @Override
        public void action() {
        createLevel(false);
        toolTip = "Level saved";
    ...
    createLevel = new Button(width-(width-squaresX), height/9*2, width-squaresX, height/9, "Create Level", "", "") {
      @Override
        public void action() {
        createLevel(true);
    ...
    createObstacle = new Button(width-(width-squaresX), height/9*3, width-squaresX, height/9, "Create Obst.", "", "") {
      @Override
        public void action() {
    ...
    createPath = new Button(width-(width-squaresX), height/9*4, width-squaresX, height/9, "Create Path", "", "") {
      @Override
        public void action() {
        isSettingPath = true;
    ...
    removeObstacle = new Button(width-(width-squaresX), height/9*5, width-squaresX, height/9, "Rem. Obst.", "", "") {
      @Override
        public void action() {
    ...
    clearPath = new Button(width-(width-squaresX), height/9*6, width-squaresX, height/9, "Clear Path", "", "") {
      @Override
        public void action() {
        clearPath();
    ...
    chooseLevel = new Button(width-(width-squaresX), height/9*7, width-squaresX, height/9, "Edit Level", "", "") {
      @Override
        public void action() {
        if (!isSelectingFile) {
    ...
    backToMM = new Button(width-(width-squaresX), height/9*8, width-squaresX, height/9, "Main Menu", "", "") {
      @Override
        public void action() {
        gameState = 0;
      }
