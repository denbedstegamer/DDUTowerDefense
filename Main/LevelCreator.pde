public class LevelCreator {
  ...
  public LevelCreator() {
    ...
    createObstacle = new Button(squaresX, height/9*3, width-squaresX, height/9, "Create Obst.", "", "") {
      @Override
        public void action() {
    ...
    removeObstacle = new Button(squaresX, height/9*5, width-squaresX, height/9, "Rem. Obst.", "", "") {
      @Override
        public void action() {
